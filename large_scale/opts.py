...
parser.add_argument('--loss_type', default="CE", type=str, help='loss type / method', choices=('CE', 'LDAM', 'BS', 'RIDE', 'NCL', 'BCL'))
...
parser.add_argument('--cutout', action='store_true', help='utiliizing cutout')
